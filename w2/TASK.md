...
1. Помните про аббревиатуры.
2. В чем разница между тегами <q> и <cite>?
3. Какая разметка используется для текста с определениями?
4. Не забывайте про <header> и <footer>.
